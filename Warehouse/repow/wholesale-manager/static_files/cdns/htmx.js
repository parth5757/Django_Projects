(function(e, t) { if (typeof define === "function" && define.amd) { define([], t) } else { e.htmx = e.htmx || t() } })(typeof self !== "undefined" ? self : this, function() {
    return function() {
        ...
        var z = {
            ...
            findAll: R,
            closest: A,
            values: function(e, t) { var r = Bt(e, t || "post"); return r.values },
            remove: O,
            addClass: q,
            removeClass: T,
            toggleClass: L,
            ...
            logAll: E,
            logger: null,
            config: { historyEnabled: true, historyCacheSize: 10, refreshOnHistoryMiss: false, defaultSwapStyle: "innerHTML", defaultSwapDelay: 0, defaultSettleDelay: 20, includeIndicatorStyles: true, indicatorClass: "htmx-indicator", requestClass: "htmx-request", addedClass: "htmx-added", settlingClass: "htmx-settling", swappingClass: "htmx-swapping", allowEval: true, inlineScriptNonce: "", attributesToSettle: ["class", "style", "width", "height"], withCredentials: false, timeout: 0, wsReconnectDelay: "full-jitter", wsBinaryType: "blob", disableSelector: "[hx-disable], [data-hx-disable]", useTemplateFragments: false, scrollBehavior: "smooth", defaultFocusScroll: false, getCacheBusterParam: false },
            parseInterval: v,
            _: e,
            createEventSource: function(e) { return new EventSource(e, { withCredentials: true }) },
        ...
        var r = { addTriggerHandler: ft, bodyContains: re, canAccessLocalStorage: S, filterValues: Wt, hasAttribute: o, getAttributeValue: J, getClosestMatch: h, getExpressionVars: rr, getHeaders: _t, getInputValues: Bt, getInternalData: K, getSwapSpecification: Gt, getTriggerSpecs: Xe, getTarget: se, makeFragment: f, mergeObjects: ne, makeSettleInfo: Zt, oobSwap: V, selectAndSwap: Oe, settleImmediately: At, shouldCancel: Ve, triggerEvent: ee, triggerErrorEvent: Q, withExtensions: wt };
        ...
        function f(e) {
            if (z.config.useTemplateFragments) { var t = l("<body><template>" + e + "</template></body>", 0); return t.querySelector("template").content } else {
                var r = s(e);
                switch (r) {
                    case "thead":
                    case "tbody":
        ...
        var I = function(e, t) { var r = $().querySelectorAll(t); for (var n = 0; n < r.length; n++) { var i = r[n]; if (i.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_PRECEDING) { return i } } };
        var k = function(e, t) { var r = $().querySelectorAll(t); for (var n = r.length - 1; n >= 0; n--) { var i = r[n]; if (i.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_FOLLOWING) { return i } } };
        ...
        function j(t, r) {
            Y(t.attributes, function(e) { if (!r.hasAttribute(e.name) && B(e.name)) { t.removeAttribute(e.name) } });
        ...
        function _(e, t, r) {
            ...
            if (n) { var i = n.split(","); for (let e = 0; e < i.length; e++) { var a = i[e].split(":", 2); var o = a[0]; if (o.indexOf("#") === 0) { o = o.substring(1) } var s = a[1] || "true"; var l = t.querySelector("#" + o); if (l) { V(s, l, r) } } }
        ...
        function ge(e) {
            ...
            ve(e);
            if (e.children) { Y(e.children, function(e) { ge(e) }) }
        }

        function pe(e, t, r) {
            if (e.tagName === "BODY") { return Se(e, t, r) } else {
                var n;
        ...
        function Ce(e, t, r, n, i) {
            switch (e) {
                ...
                default:
                    var a = gr(t);
                    for (var o = 0; o < a.length; o++) { var f = a[o]; try { var s = f.handleSwap(e, r, n, i); if (s) { if (typeof s.length !== "undefined") { for (var l = 0; l < s.length; l++) { var u = s[l]; if (u.nodeType !== Node.TEXT_NODE && u.nodeType !== Node.COMMENT_NODE) { i.tasks.push(ue(u)) } } } return } } catch (e) { St(e) } }
                    if (e === "innerHTML") { Se(r, n, i) } else { Ce(z.config.defaultSwapStyle, t, r, n, i) }
            }
        }
                ...
                while (t.length > 0) {
                    ...
                    if (o === "]") {
                        ...
                        if (n === 0) {
                            ...
                            i += ")})";
                            try {
                                var s = Qt(e, function() { return Function(i)() }, function() { return true });
                                s.source = i;
                                return s
                            } catch (e) { Q($().body, "htmx:syntax:error", { error: e, source: i }); return null }
                        }
                    } else if (o === "[") { n++ }
                    if (Me(o, a, r)) { i += "((" + r + "." + o + ") ? (" + r + "." + o + ") : (window." + o + "))" } else { i = i + o }
                    a = t.shift()
                }
            }
        }
                        ...
                        if (i === "every") {
                            ...
                            while (n.length > 0 && n[0] !== ",") {
                                ...
                                if (l === "changed") { s.changed = true } else if (l === "once") { s.once = true } else if (l === "consume") { s.consume = true } else if (l === "delay" && n[0] === ":") {
                                    ...
                                    n.shift();
                                    s[l] = c(n, Le)
                                } else { Q(e, "htmx:syntax:error", { token: n.shift() }) }
                            }
                            r.push(s)
                        }
                    }
                    if (n.length === f) { Q(e, "htmx:syntax:error", { token: n.shift() }) }
                    c(n, Ie)
                } while (n[0] === "," && n.shift())
            }
            if (r.length > 0) { return r } else if (d(e, "form")) { return [{ trigger: "submit" }] } else if (d(e, 'input[type="button"]')) { return [{ trigger: "click" }] } else if (d(e, De)) { return [{ trigger: "change" }] } else { return [{ trigger: "click" }] }
        }
        ...
        function Be(e, t, r) {
            ...
            n.timeout = setTimeout(function() {
                if (re(e) && n.cancelled !== true) {
                    if (!We(r, xt("hx:poll:trigger", { triggerSpec: r, target: e }))) { t(e) }
                    Be(e, t, r)
                }
            }, r.pollInterval)
        }
        ...
        function ze(a, o, e, s, l) {
            var t;
            if (s.from) { t = N(a, s.from) } else { t = [a] }
            Y(t, function(n) {
                var i = function(e) {
                    if (!re(a)) { n.removeEventListener(s.trigger, i); return }
                    if (_e(a, e)) { return }
        ...
        function $e() {
            if (!Je) {
                ...
                setInterval(function() {
                    if (Ge) {
                        Ge = false;
                        Y($().querySelectorAll("[hx-trigger='revealed'],[data-hx-trigger='revealed']"), function(e) { Ze(e) })
                    }
                }, 200)
            }
        }
        ...
        function Ye(s, r, n) {
            ...
            t.addEventListener("message", function(e) {
                if (Qe(s)) { return }
                var t = e.data;
                wt(s, function(e) { t = e.transformResponse(t, null, s) });
                var r = Zt(s);
                var n = f(t);
                var i = y(n.children);
        ...
        function et(u) {
            var f = h(u, function(e) { return K(e).webSocket != null });
            if (f) {
                u.addEventListener(Xe(u)[0].trigger, function(e) {
                    ...
                    var l = Wt(s, u);
                    l["HEADERS"] = r;
                    if (i && i.length > 0) { ee(u, "htmx:validation:halted", i); return }
        ...
        function it(a, o) {
            ...
            if (s) {
                ...
                var u = function(e) {
                    if (ot(s)) { l.removeEventListener(o, u); return }
                    var t = e.data;
                    wt(a, function(e) { t = e.transformResponse(t, null, a) });
                    var r = Gt(a);
                    var n = se(a);
                    var i = Zt(a);
        ...
        function at(e, t, r) {
            ...
            if (n) {
                ...
                var a = function() { if (!ot(n)) { if (re(e)) { t(e) } else { i.removeEventListener(r, a) } } };
                K(e).sseListener = a;
        ...
        function ut(t, i, e) {
            ...
            Y(n, function(r) {
                if (o(t, "hx-" + r)) {
                    ...
                    i.path = n;
                    i.verb = r;
                    e.forEach(function(e) { ft(t, e, i, function(e, t) { lr(r, n, e, t) }) })
                }
            });
            return a
        }
        ...
        function ft(n, e, t, r) {
            if (e.sseEvent) { at(n, r, e.sseEvent) } else if (e.trigger === "revealed") {
                $e();
                ze(n, r, t, e);
                Ze(n)
                ...
                var a = new IntersectionObserver(function(e) { for (var t = 0; t < e.length; t++) { var r = e[t]; if (r.isIntersecting) { ee(n, "intersect"); break } } }, i);
                a.observe(n);
                ze(n, r, t, e)
            } else if (e.trigger === "load") { if (!We(e, xt("load", { elt: n }))) { lt(n, r, t, e.delay) } } else if (e.pollInterval) {
                t.polling = true;
                Be(n, r, e)
            } else { ze(n, r, t, e) }
        }
        ...
        function ct(e) {
            if (e.type === "text/javascript" || e.type === "module" || e.type === "") {
                ...
                try { r.insertBefore(t, e) } catch (e) { St(e) } finally { if (e.parentElement) { e.parentElement.removeChild(e) } }
            }
        }
        ...
        function ee(e, t, r) {
            ...
            wt(e, function(e) { i = i && e.onEvent(t, n) !== false });
            return i
        }
        ...
        function Lt(e) {
            if (z.config.getCacheBusterParam) { e = e.replace(/org\.htmx\.cache-buster=[^&]*&?/, ""); if (e.endsWith("&") || e.endsWith("?")) { e = e.slice(0, -1) } }
        ...
        function Nt(a) {
            ...
            e.onload = function() {
                if (this.status >= 200 && this.status < 400) {
                    ...
                    if (n) { var i = C("title"); if (i) { i.innerHTML = n } else { window.document.title = n } }
                    Se(t, e, r);
                    At(r.tasks);
                    Et = a;
        ...
        function It(e) {
            ...
            } else { if (z.config.refreshOnHistoryMiss) { window.location.reload(true) } else { Nt(e) } }
        }
        ...
        function Xt(t, r, n, e, i) {
            if (e == null || Pt(t, e)) { return } else { t.push(e) }
            if (Dt(e)) { var a = G(e, "name"); var o = e.value; if (e.multiple) { o = y(e.querySelectorAll("option:checked")).map(function(e) { return e.value }) } if (e.files) { o = y(e.files) } if (a != null && o != null) { var s = r[a]; if (s !== undefined) { if (Array.isArray(s)) { if (Array.isArray(o)) { r[a] = s.concat(o) } else { s.push(o) } } else { if (Array.isArray(o)) { r[a] = [s].concat(o) } else { r[a] = [s, o] } } } else { r[a] = o } } if (i) { Ft(e, n) } }
            if (d(e, "form")) {
                var l = e.elements;
        ...
        function Bt(e, t) {
            ...
            Xt(r, n, a, e, s);
            if (o.lastButtonClicked) { var l = G(o.lastButtonClicked, "name"); if (l) { n[l] = o.lastButtonClicked.value } }
        ...
        function _t(e, t, r) {
            var n = { "HX-Request": "true", "HX-Trigger": G(e, "id"), "HX-Trigger-Name": G(e, "name"), "HX-Target": J(t, "id"), "HX-Current-URL": $().location.href };
        ...
        function Gt(e, t) {
            ...
            var n = { swapStyle: K(e).boosted ? "innerHTML" : z.config.defaultSwapStyle, swapDelay: z.config.defaultSwapDelay, settleDelay: z.config.defaultSettleDelay };
        ...
        function $t(t, r, n) {
            var i = null;
            wt(r, function(e) { if (i == null) { i = e.encodeParameters(t, n, r) } });
            if (i != null) { return i } else { if (Jt(r)) { return Vt(n) } else { return Ut(n) } }
        }
        ...
        function Yt(e, t, r, n) {
            ...
            if (i) {
                ...
                if (a.indexOf("{") !== 0) { a = "{" + a + "}" }
                var s;
                if (o) { s = Qt(e, function() { return Function("return (" + a + ")")() }, {}) } else { s = w(a) }
        ...
        function lr(e, t, n, r, i, f) {
            ...
            if (g == null || g == ae) { Q(n, "htmx:targetError", { target: J(n, "hx-target") }); return }
            if (!f) { var p = function() { return lr(e, t, n, r, i, true) }; var m = { target: g, elt: n, path: t, verb: e, triggeringEvent: r, etc: i, issueRequest: p }; if (ee(n, "htmx:confirm", m) === false) { return } }
            var y = n;
            var a = K(n);
            var x = Z(n, "hx-sync");
            var b = null;
            ...
            if (x) {
                var S = x.split(":");
                var E = S[0].trim();
                if (E === "this") { y = oe(n, "hx-sync") } else { y = ie(n, E) }
                x = (S[1] || "drop").trim();
                a = K(y);
                if (x === "drop" && a.xhr && a.abortable !== true) { return } else if (x === "abort") { if (a.xhr) { return } else { w = true } } else if (x === "replace") { ee(y, "htmx:abort") } else if (x.indexOf("queue") === 0) {
                    var C = x.split(" ");
                    b = (C[1] || "last").trim()
                }
            }
            if (a.xhr) {
                if (a.abortable) { ee(y, "htmx:abort") } else {
                    if (b == null) { if (r) { var R = K(r); if (R && R.triggerSpec && R.triggerSpec.queue) { b = R.triggerSpec.queue } } if (b == null) { b = "last" } }
                    if (a.queuedRequests == null) { a.queuedRequests = [] }
                    if (b === "first" && a.queuedRequests.length === 0) { a.queuedRequests.push(function() { lr(e, t, n, r, i) }) } else if (b === "all") { a.queuedRequests.push(function() { lr(e, t, n, r, i) }) } else if (b === "last") {
                        a.queuedRequests = [];
                        a.queuedRequests.push(function() { lr(e, t, n, r, i) })
                    }
                    return
                }
            }
            ...
            var D = K(n).boosted;
            var l = { boosted: D, parameters: M, unfilteredParameters: k, headers: L, target: g, verb: e, errors: A, withCredentials: i.credentials || P.credentials || z.config.withCredentials, timeout: i.timeout || P.timeout || z.config.timeout, path: t, triggeringEvent: r };
            ...
            var u = { xhr: o, target: g, requestConfig: l, etc: i, boosted: D, pathInfo: { requestPath: t, finalRequestPath: j || t, anchor: B } };
            o.onload = function() {
                try {
                    var e = sr(n);
                    ...
                    if (!re(n)) {
                        var t = null;
                        while (e.length > 0 && t == null) { var r = e.shift(); if (re(r)) { t = r } }
                        if (t) {
                    ...
                    te(c);
                    s()
                } catch (e) { Q(n, "htmx:onLoadError", ne({ error: e }, u)); throw e }
            };
            o.onerror = function() {
                Mt(W);
        ...
        function fr(s, l) {
            ...
            if (ar(u, /HX-Location:/i)) {
                ...
                or("GET", e, c).then(function() { Lt(e) });
                return
            }
            if (ar(u, /HX-Redirect:/i)) { location.href = u.getResponseHeader("HX-Redirect"); return }
            if (ar(u, /HX-Refresh:/i)) { if ("true" === u.getResponseHeader("HX-Refresh")) { location.reload(); return } }
            ...
            if (r.shouldSwap) {
                ...
                wt(s, function(e) { d = e.transformResponse(d, u, s) });
                if (h.type) { Tt() }
                ...
                var o = function() {
                    try {
                        ...
                        if (t.elt && !re(t.elt) && t.elt.id) {
                            ...
                            if (r) {
                                if (t.start && r.setSelectionRange) { try { r.setSelectionRange(t.start, t.end) } catch (e) {} }
                                r.focus(i)
                            }
                        }
                        ...
                        var o = function() {
                            ...
                            if (l.pathInfo.anchor) { var e = C("#" + l.pathInfo.anchor); if (e) { e.scrollIntoView({ block: "start", behavior: "auto" }) } }
                            if (n.title) { var t = C("title"); if (t) { t.innerHTML = n.title } else { window.document.title = n.title } }
                            Kt(n.elts, c);
                    ...
                    } catch (e) { Q(s, "htmx:swapError", l); throw e }
                };
                if (c.swapDelay > 0) { setTimeout(o, c.swapDelay) } else { o() }
            }
            if (t) { Q(s, "htmx:responseError", ne({ error: "Response Status Error Code " + u.status + " from " + l.pathInfo.requestPath }, l)) }
        }
        var cr = {};
        ...
        pr(function() {
            ...
            setTimeout(function() { ee(e, "htmx:load", {}) }, 0)
        });
        return z
    }()
});